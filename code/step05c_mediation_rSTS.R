...
write.csv(
  results_tbl,
  "/Users/jinke/Downloads/mediation_results_roi98.csv",
  row.names = FALSE
)

write.csv(
  data.frame(ACME_null = med_out$d0.sims),
  "/Users/jinke/Downloads/ACME_null_roi98.csv",
  row.names = FALSE
)
